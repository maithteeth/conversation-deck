        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
            ...
            <div className="grid gap-3">
              {decks.map(d => (
                <button 
                  ...
                  className={`flex items-center justify-between p-6 rounded-2xl border transition-all ${selectedDeckId === d.id ? "bg-zinc-900 border-zinc-900 text-white shadow-lg" : "bg-white border-zinc-100 text-zinc-600 hover:border-zinc-300 shadow-sm"}`}
                >
          ...
          <TabsContent value="edit" className="space-y-10 outline-none">
            ...
            <section className="space-y-6">
              <h3 className="text-[10px] font-bold text-zinc-300 tracking-[0.2em] uppercase px-1">カード編集：{selectedDeck?.name}</h3>
